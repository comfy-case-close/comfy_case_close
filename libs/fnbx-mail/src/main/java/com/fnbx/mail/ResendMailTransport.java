...
@Component
@ConditionalOnProperty(name = "fnb.mail.provider", havingValue = "resend")
public class ResendMailTransport implements MailTransport {
    ...
    @Autowired
    public ResendMailTransport(@Value("${fnb.mail.resend.api-key:}") String apiKey) {
    ...
    public void send(EmailMessage message) {
        if (!StringUtils.hasText(apiKey)) {
            throw MailDeliveryException.providerMisconfigured("fnb.mail.resend.api-key is not set");
        }
